...
1. Cài đặt các thư viện cần thiết bằng lệnh:
   ...
   ```
   _(Lưu ý: Đối với việc trích xuất PhoBERT embedding, nếu máy tính của bạn có GPU hỗ trợ CUDA, hãy cài đặt phiên bản PyTorch tương thích CUDA để tăng tốc độ xử lý)._
