...
```
*(Note: If your system has an NVIDIA GPU, it is highly recommended to install the CUDA-supported version of PyTorch (`torch`) to significantly accelerate the PhoBERT embedding extraction).*
